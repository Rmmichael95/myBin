...
for file in *.csv; do
    ...
    head -n 1 "$file" >"${file%.*}-MT.csv"
    head -n 1 "$file" >"${file%.*}-CE.csv"
    ...
    sed -i '/\"AK\"/d' "$file"
    rg \"MT\" "$file" >>"${file%.*}-MT.csv"
    sed -i '/\"MT\"/d' "$file"
    rg \"ID\" "$file" >>"${file%.*}-MT.csv"
    sed -i '/\"ID\"/d' "$file"
    rg \"WY\" "$file" >>"${file%.*}-MT.csv"
    sed -i '/\"WY\"/d' "$file"
    rg \"UT\" "$file" >>"${file%.*}-MT.csv"
    sed -i '/\"UT\"/d' "$file"
    rg \"CO\" "$file" >>"${file%.*}-MT.csv"
    sed -i '/\"CO\"/d' "$file"
    rg \"AZ\" "$file" >>"${file%.*}-MT.csv"
    sed -i '/\"AZ\"/d' "$file"
    rg \"NM\" "$file" >>"${file%.*}-MT.csv"
    sed -i '/\"NM\"/d' "$file"
    rg \"ND\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"ND\"/d' "$file"
    rg \"SD\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"SD\"/d' "$file"
    rg \"NE\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"NE\"/d' "$file"
    rg \"KS\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"KS\"/d' "$file"
    rg \"OK\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"OK\"/d' "$file"
    rg \"TX\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"TX\"/d' "$file"
    rg \"MN\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"MN\"/d' "$file"
    rg \"IA\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"IA\"/d' "$file"
    rg \"NO\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"NO\"/d' "$file"
    rg \"AR\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"AR\"/d' "$file"
    rg \"LA\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"LA\"/d' "$file"
    rg \"WI\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"WI\"/d' "$file"
    rg \"IL\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"IL\"/d' "$file"
    rg \"MS\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"MS\"/d' "$file"
    rg \"AL\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"AL\"/d' "$file"
    rg \"TN\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"TN\"/d' "$file"
    rg \"MO\" "$file" >>"${file%.*}-CE.csv"
    sed -i '/\"MO\"/d' "$file"
